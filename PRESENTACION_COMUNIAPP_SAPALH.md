# Presentacion: ComuniApp SAPALH La Huerta

## 1. Portada

ComuniApp SAPALH: comunicados y reportes ciudadanos para el cuidado del agua en La Huerta, Jalisco.
...
Una app movil en Expo que centraliza avisos oficiales, reportes anonimos con foto y GPS, mapa de puntos de interes y directorio de contacto de SAPALH.

## 4. Usuarios

Habitantes del municipio, personal de SAPALH y autoridades que necesitan visualizar incidencias para priorizar atencion.
...
La app esta enfocada en SAPALH y en el contexto local de La Huerta. Agrega educacion de cuidado del agua y seguimiento por estado para mejorar la confianza ciudadana.
...
- APK listo para generarse con EAS (`preview`).
- Presentacion editable y demo funcional.

## 12. Cierre

ComuniApp SAPALH ayuda a comunicar, reportar y ubicar problemas del agua desde una experiencia movil clara, moderna y util para la comunidad.
